      ...
      <div>
        <div className='home-section'>
          ...
          <div className={this.state.mcqsClass}>
            ...
            <div>
              <h1>
                Chemistry Class 10<sup>th</sup> MCQs with Answers
              </h1>

              <p>
                We displays a series of Multiple Choice Questions (MCQs) and
                answers based quizzes for online learning on grade 10 chemistry
              ...
              <div className='main phy-main'>
                ...
                <div className='chapter'>
                  <p>Chapter 3:</p>
                  <p className='mainTitle'>Organic Chemistry</p>
                  <div className='btn'>
                    <a>
                ...
                <div className='chapter'>
                  <p>Chapter 5:</p>
                  <p className='mainTitle'>Biochemistry</p>
                  <div className='btn'>
                    <a>
                ...
                <div className='chapter'>
                  <p>Chapter 6:</p>
                  <p className='mainTitle'>The Atmosphere</p>
                  <div className='btn'>
                    <a>
