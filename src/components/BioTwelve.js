...
export default class Maths9th extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      Name : 'phyMcqs',
      change: 'home',
      mcqsClass : 'mcqsContent bioMcqsContentEleven'
    }
  }

  backHandler = ()=>{
    this.setState({change : 'home', mcqsClass : 'mcqsContent bioMcqsContentEleven'})
  }
      ...
      <div>
        <div className='home-section'>
          ...
          <div className={this.state.mcqsClass}>
            ...
            <div>
              <h1>
                Biology Class 12<sup>th</sup> MCQs with Answers
              </h1>

              <p>
                We displays a series of Multiple Choice Questions (MCQs) and
                answers based quizzes for online learning on grade 12 biology
              ...
              <div className='main phy-main'>
                ...
                <div className='chapter'>
                  <p>Chapter 3:</p>
                  <p className='mainTitle'>Coordination and Control</p>
                  <div className='btn'>
                    <a>
                ...
                <div className='chapter'>
                  <p>Chapter 5:</p>
                  <p className='mainTitle'>Growth and Development</p>
                  <div className='btn'>
                    <a>
                ...
                <div className='chapter'>
                  <p>Chapter 6:</p>
                  <p className='mainTitle'>Chromosomes and DNA</p>
                  <div className='btn'>
                    <a>
