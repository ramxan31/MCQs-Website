...
export default class Maths9th extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      Name : 'phyMcqs',
      change: 'home',
      mcqsClass : 'mcqsContent chemMcqsContentTwelve'
    }
  }
  backHandler = ()=>{
    this.setState({change : 'home', mcqsClass : 'mcqsContent chemMcqsContentTwelve'})
  }
      ...
      <div>
        <div className='home-section'>
          ...
          <div className={this.state.mcqsClass}>
            ...
            <div>
              <h1>
                Chemistry Class 12<sup>th</sup> MCQs with Answers
              </h1>

              <p>
                We displays a series of Multiple Choice Questions (MCQs) and
                answers based quizzes for online learning on grade 12 chemistry
              ...
              <div className='main phy-main'>
                ...
                <div className='chapter'>
                  <p>Chapter 3:</p>
                  <p className='mainTitle'>Group IIIA and Group IVA Elements</p>
                  <div className='btn'>
                    <a>
                ...
                <div className='chapter'>
                  <p>Chapter 5:</p>
                  <p className='mainTitle'>The Halogens and the Noble Gases</p>
                  <div className='btn'>
                    <a>
                ...
                <div className='chapter'>
                  <p>Chapter 6:</p>
                  <p className='mainTitle'>Transition Elements</p>
                  <div className='btn'>
                    <a>
                ...
                <div className='chapter'>
                  <p>Chapter 7:</p>
                  <p className='mainTitle'>
                    Fundamental Principles of Organic Chemistryx
                  </p>
                  <div className='btn'>
                    <a>
