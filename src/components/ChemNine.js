...
import McqsHandler from '../components/McqsHandler';
...
export default class Maths9th extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      Name : 'phyMcqs',
      change: 'home',
      mcqsClass : 'mcqsContent chemMcqsContent'
    }
  }
  backHandler = ()=>{
    this.setState({change : 'home', mcqsClass : 'mcqsContent chemMcqsContent'})
  }
      ...
      <div>
        <div className='home-section'>
          ...
          <div className={this.state.mcqsClass}>
            ...
            <div>
              <h1>
                Chemistry Class 9<sup>th</sup> MCQs with Answers
              </h1>

              <p>
                We displays a series of Multiple Choice Questions (MCQs) and
                answers based quizzes for online learning on grade 9 chemistry
              ...
              <div className='main phy-main'>
                ...
                <div className='chapter'>
                  <p>Chapter 3:</p>
                  <p className='mainTitle'>Periodic Table and Periodicity of Properties</p>
                  <div className='btn'>
                    <a>
                ...
                <div className='chapter'>
                  <p>Chapter 5:</p>
                  <p className='mainTitle'>Physical States of Matter</p>
                  <div className='btn'>
                    <a>
                ...
                <div className='chapter'>
                  <p>Chapter 6:</p>
                  <p className='mainTitle'>Solutions</p>
                  <div className='btn'>
                    <a>
