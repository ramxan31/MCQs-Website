...
import {ch1mcqs, ch2mcqs, ch3mcqs, ch4mcqs, ch5mcqs, ch6mcqs, ch7mcqs, ch8mcqs, ch9mcqs } from "../MCQs/PhyNineMcqs";
        ...
        <div className='home-section'>
          ...
          <div className={this.state.mcqsClass}>
            {this.state.change === 'home' &&
              <div>
              <h1>
                Physics Class 9<sup>th</sup> MCQs with Answers
              </h1>

              <p>
                We displays a series of Multiple Choice Questions (MCQs) and
                answers based quizzes for online learning on grade 9 physics
              ...
              <div className='main phy-main'>
                ...
                <div className='chapter'>
                  <p>Chapter 3:</p>
                  <p className='mainTitle'>Dynamics</p>
                  <div className='btn'>
                    <a>
                ...
                <div className='chapter'>
                  <p>Chapter 5:</p>
                  <p className='mainTitle'>Gravitation</p>
                  <div className='btn'>
                    <a>
                ...
                <div className='chapter'>
                  <p>Chapter 6:</p>
                  <p className='mainTitle'>Work and Energy</p>
                  <div className='btn'>
                    <a>
