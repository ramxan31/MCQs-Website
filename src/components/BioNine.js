...
import { ch1, ch1mcqs, ch2, ch2mcqs } from "../MCQs/BioNineMcqs";
...
export default class Maths9th extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      Name : 'phyMcqs',
      change: 'home',
      mcqsClass : 'mcqsContent bioMcqsContent'
    }
  }

  backHandler = ()=>{
    this.setState({change : 'home', mcqsClass : 'mcqsContent bioMcqsContent'})
  }
      ...
      <div>
        <div className='home-section'>
          ...
          <div className={this.state.mcqsClass}>
            ...
            <div>
              <h1>
                Biology Class 9<sup>th</sup> MCQs with Answers
              </h1>

              <p>
                We displays a series of Multiple Choice Questions (MCQs) and
                answers based quizzes for online learning on grade 9 biology
              ...
              <div className='main phy-main'>
                ...
                <div className='chapter'>
                  <p>Chapter 3:</p>
                  <p className='mainTitle'>Bio-diversity</p>
                  <div className='btn'>
                    <a>
                ...
                <div className='chapter'>
                  <p>Chapter 5:</p>
                  <p className='mainTitle'>Cell cycle</p>
                  <div className='btn'>
                    <a>
                ...
                <div className='chapter'>
                  <p>Chapter 6:</p>
                  <p className='mainTitle'>Enzymes</p>
                  <div className='btn'>
                    <a>
